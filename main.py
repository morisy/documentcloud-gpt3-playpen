    ...
    def main(self):
        ...
        with open("compared_docs.csv", "w+") as file_:
            ...
            for doc_id in documents:
                ...
                relevance = response_list[-9]
                certainty = response_list[-7]
