...
class GPTPlay(AddOn):    
    def main(self):
        ...
        with open("compared_docs.csv", "w+") as file_:
            ...
            writer.writerow(
                ["document_title", "url", "relevance", "certainty", "reason", "document type", "newsworthiness", "entities", "summary"]
            )
