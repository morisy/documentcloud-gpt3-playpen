    ...
    def main(self):
        ...
        if self.get_documents():  # Check to make sure there are documents:
            with open("compared_docs.csv", "w+") as file_:
                ...
                user_input = self.data.get("prompt").translate(
                    str.maketrans(
                        {
                            "-": r"\-",
                            "]": r"\]",
                ...
                for document in self.get_documents():
                    ...
                    try:
                        ...
                        full_text = document.get_page_text(1).translate(
                            str.maketrans(
                                {
                                    "-": r"\-",
                                    "]": r"\]",
            ...
            self.set_message(
                "It looks like no documents were selected. Search for some or select them and run again."
            )
